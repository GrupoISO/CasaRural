...
var w_dayname = new Array("Lun","Mar","Mie","Jue","Vie","Sab", "Dom");
var w_StartOfWeek = 0; // Lunes
...
function w_writeDayname()
{
    ...
    document.write('<td class="week" id="weekHeader">Semana</td>');
