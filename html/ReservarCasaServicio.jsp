...
<head>
	...
	<title>Selección de Servicio de Recogida</title>
...
<body>
	<div class="container">
		<h1>Selección de Servicio de Recogida</h1>
		<%
			String select = request.getParameter("servicio");
			if (select != null && select.equals("si")) {
				List<Servicio> listaServicios = servicioRecogidaBean.MostrarServicios(reservarCasaBean.getNumCasa(), reservarCasaBean.getDiaIniDate());
				...
				<table>
					<thead>
						<tr>
							...
							<th><b><u>Elija número de plazas</u></b>
						</tr>
					</thead>
					<tbody>
						<%
