...
{try{jbInit();
  ...
  private void jbInit() throws Exception
  {
    ...
    jLabel1.setBounds(new Rectangle(10, 35, 293, 25));
    jLabel2.setBounds(new Rectangle(10, 75, 364, 30));
    jLabel3.setBounds(new Rectangle(45, 155, 329, 35));
    ...
    jLabel4.setBounds(new Rectangle(276, 40, 98, 20));
    jLabel5.setBounds(new Rectangle(130, 80, 244, 25));
    jLabel6.setBounds(new Rectangle(10, 120, 364, 25));
    jLabel7.setBounds(new Rectangle(125, 120, 249, 25));
