...
/** @startuml
actor Cliente #red
Cliente --> IUEncontrarMejorReserva : encontrarMejorReserva(fechaEntrada,fechaSalida,numHabitaciones,numBaños,criterio[precio|tamaño])
IUEncontrarMejorReserva --> GestorOfertas : encontrarMejorOferta(fechaEntrada,fechaSalida,numHabitaciones,numBaños,criterio[precio|tamaño])
GestorOfertas --> GestorBD : seleccionarCasas()
GestorOfertas <-- GestorBD : listaDeCasas
loop Por cada casa
	GestorOfertas --> GestorBD : seleccionarOfertas(codigoCasa)
	GestorOfertas <-- GestorBD : listaDeOfertas
end
IUEncontrarMejorReserva <-- GestorOfertas : mejorReserva
 * @enduml
 */
...
public class encontrarMejorReserva extends JFrame 
{
  ...
  private String[] lista={"precio","tamaÃ±o"};
