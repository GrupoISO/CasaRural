...
/** @startuml
actor Cliente #red
Cliente --> IUConsultarDisponibilidad : consultarDisponibilidad(codigoCasa,fechaEntrada,numNoches)
IUConsultarDisponibilidad --> GestorOfertas: obtenerOfertas(codigoCasa,fechaEntrada,numNoches)
GestorOfertas --> GestorBD : seleccionarOfertas(codigoCasa,fechaEntrada,numNoches)
GestorOfertas <-- GestorBD: listaDeOfertas
IUConsultarDisponibilidad <-- GestorOfertas: listaDeOfertas
 * @enduml
 */
...
public class ConsultarDisponibilidad extends JFrame 
{
  ...
  private void jbInit() throws Exception
  {
    ...
    scrollPane.setBounds(new Rectangle(34, 305, 364, 135));
    ...
    jTextArea1.setBounds(35, 307, 364, 131);
