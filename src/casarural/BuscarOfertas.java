...
/** @startuml
actor Cliente #red
Cliente --> IUBuscarOfertas : buscarOfertas(fechaEntrada,fechaSalida,[numDias],[precioMinimo],[minDormitorios],[minBaños],[criterio(precio|dias)])
IUBuscarOfertas --> GestorOfertas : buscarOfertas(fechaEntrada,fechaSalida,[numDias],[precioMinimo],[minDormitorios],[minBaños],[criterio(precio|dias)])
GestorOfertas --> GestorBD : 2. seleccionarCasasDorWC(fechaEntrada,fechaSalida,[numDias],[precioMinimo],[minDormitorios],[minBaños],[criterio(precio|dias)])
...
public class BuscarOfertas extends JFrame {
	...
	/**
	 * This method initializes TextBaÃ±os
	 * 
	 * @return javax.swing.JTextField
	 */
			...
			Buscar.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (jTextField2.getText().equals("")
						...
						// comprobamos si el campo estÃ¡ vacÃ­o. Si no lo estÃ¡,
